export function reportReadyHtml({
  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
      <h1 style="color:#2563eb;margin-bottom:24px;">Your Inspection Report is Ready</h1>
      <p>Hi ${customerName},</p>
      <p>The inspection report for your <strong>${vehicleYear} ${vehicleMake} ${vehicleModel}</strong> is now available.</p>
