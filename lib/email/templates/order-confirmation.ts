export function orderConfirmationHtml({
  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">
      ...
      <p>Hi ${customerName},</p>
      <p>Your RideCheck inspection order has been received!</p>
      ...
      ${bookingType === "self_arrange" ? "<p>Please complete payment to proceed with your inspection.</p>" : "<p>Our team will contact the seller and reach out to you once the appointment is confirmed.</p>"}
